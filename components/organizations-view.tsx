    ...
    <div className="grid grid-cols-1 gap-4 2xl:grid-cols-[430px_minmax(320px,1fr)]">
      <form onSubmit={onCreate} className="rounded-lg border border-[#d8dde6] bg-white p-4">
        ...
        <div className="mt-4 space-y-4">
          ...
          <fieldset className="border-t border-[#e4e7ec] pt-4">
        ...
        <div className="divide-y divide-[#eef2f6]">
          {organizations.map((organization) => (
            <button
              ...
              className={`flex w-full items-center justify-between gap-3 p-4 text-left hover:bg-[#f8fafc] ${selectedOrganizationId === organization.id ? "bg-[#f0f7f7]" : ""}`}
            >
